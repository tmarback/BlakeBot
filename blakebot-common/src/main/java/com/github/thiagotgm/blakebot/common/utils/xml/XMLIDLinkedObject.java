...
/**
 * XML wrapper for <tt>IIDLinkedObject</tt>s. The actual reading and writing is
 * delegated to a wrapper of the IIDLinkedObject subtype, so the supported
...
public class XMLIDLinkedObject extends AbstractXMLWrapper<IIDLinkedObject> {
    ...
    /**
     * Retrieves the tag that identifies the stored object.
     *
     * @return The tag.
     * @throws IllegalStateException if there is no currently wrapped object.
     */
     ...
     * <p>
     * The start element is expected to already have been read, and no data is
     ...
     * <p>
     * Eventually closing the element (using
     * {@link XMLStreamWriter#writeEndElement()}) is responsibility of the
     * caller.
     *
