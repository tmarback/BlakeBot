...
public class CardCommands {
    ...
    @SubCommand(
            ...
            description = "Retrieves a custom card owned by the specified user (if no user is "
                    ...
                    + "specified through either a mention or through the format " + "[name]#[discriminator].",
    ...
    @SubCommand(
            ...
            description = "Adds a custom card with the given name (title) to yourself. "
                    ...
                    + "your card slots. Also, the title must be limited to " + Card.MAX_TITLE_LENGTH + " characters.",
    ...
    @SubCommand(
            ...
            description = "Changes the name (title) of the custom card with the given name to the "
                    + "given new name. The new title must be limited to " + Card.MAX_TITLE_LENGTH + " characters.",
            usage = "{}card changetitle|ct|settitle|st|edittitle|edit <current card name> <new card name>",
            successHandler = SUCCESS_HANDLER,
            failureHandler = FAILURE_HANDLER )
    ...
    @SubCommand(
            ...
            description = "Sets the text of the field with the given name in the given card.\n"
                    ...
                    + "is created. There is also a limitation that the field name can only have " + "up to "
                    + Card.MAX_FIELD_NAME_LENGTH + " characters, and the field text " + "can only have up to "
                    + Card.MAX_FIELD_TEXT_LENGTH + " characters.\nNOTE: "
    ...
    @SubCommand(
            ...
            description = "Sets the description of the given card. If no description is "
                    + "given, the current description is deleted.\nThe description is " + "limited to "
                    + Card.MAX_DESCRIPTION_LENGTH + " characters.",
    ...
    @SubCommand(
            ...
            description = "Sets the footer of the given card. If no footer is "
                    + "given, the current footer is deleted.\nThe footer is " + "limited to " + Card.MAX_FOOTER_LENGTH
                    + " characters.",
    ...
    @SubCommand(
            ...
            description = "Sets the icon of the footer of the given card (the image next "
                    ...
                    + "card will fail to be shown until the icon URL is replaced with a " + "valid URL (or removed).",
    ...
    @SubCommand(
            ...
            description = "Sets the image of the given card (the big image in the bottom). "
                    ...
                    + "\nThe URL is not checked for validity, but if it is invalid, the "
                    + "card will fail to be shown until the image URL is replaced with a " + "valid URL (or removed).",
    ...
    public void failureHandler( CommandContext context, FailureReason reason ) {
        ...
        switch ( reason ) {
            ...
            case DISCORD_ERROR:
                if ( context.getCommand().getName().equals( GET_SUBCOMMAND ) && context.getHelper().isPresent() ) { // Error
                                                                                                                    // with
                                                                                                                    // card
                                                                                                                    // embed.
